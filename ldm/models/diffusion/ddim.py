...
class DDIMSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True):
        self.ddim_timesteps = make_ddim_timesteps(ddim_discr_method=ddim_discretize,            # "uniform"
                                                  num_ddim_timesteps=ddim_num_steps,            # ddim steps
                                                  num_ddpm_timesteps=self.ddpm_num_timesteps,   # 1000
    ...
    def sample(self,
        ...
        samples = self.ddim_sampling(conditioning, 
                                                    size, 
                                                    pose,
                                                    callback=callback,
